...
%deghat kuni mibini jofteshoon be ye shekl converge mishan. albate malom
%nist ke hamishe in etefagh biofte. dar vaghe example e hanoz peyda nashode
%ke in be yek chiz hamgara nashan vali proof e ham ndarim ke hatman hamishe
%be yek chiz hamgara mishan
% nokte besiar mohem ine ke vaghti h==[0;0;0;0] mizari va az dakhel shoro
% mikuni tamame set haye ke in beyn ijad mishe control invariant hastan by
% construction.
% vali agar az outside shoro kuni hichkodom control invariant nistan ta
% zamani ke be limit yani akhari beresi. so a logical approximation would
% be to grow from inside to outside